    ...
    n.fn.paging = function (y, z) {
        var w = this, b = {
            setOptions: function (a) {
                ...
                b.interval && t.clearInterval(b.interval);
                b.a.refresh.url && (b.interval = t.setInterval(function () {
                    n.ajax({
                ...
                if (b.a.lock)return b.a.onSelect(0), b;
                if (r === a) {
                    if (a = b.a.page, null === a)return b
                } else if (b.a.page == a)return b;
                b.a.page = a |= 0;
                var m = b.l, g = b.a, h, e, c, p, v = 1, f = b.format, d, k, l, q, x = f.d.length,
                    s = x;
                ...
                for (p = ""; ++s < x;) {
                    ...
                    switch (l.e) {
                        case "block":
                            for (; h < e; ++h)d.value = h, d.pos = 1 + f.b - e + h, d.active = h <= c || 0 > m, d.first = 1 === h, d.last = h === c && 0 < m, u(g, d, l.e);
                            continue;
                        case "left":
                            d.value = l.c;
                            d.active = l.c < h;
